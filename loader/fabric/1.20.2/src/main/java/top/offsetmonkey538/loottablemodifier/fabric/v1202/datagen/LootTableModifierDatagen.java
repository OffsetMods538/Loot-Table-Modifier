package top.offsetmonkey538.loottablemodifier.fabric.v1202.datagen;
                    ...
                    LootModifier.builder()
                            .conditionally(
                                    TablePredicate.builder()
                                            .name(EntityType.CREEPER.getDefaultLootTable().location().toString()) // TODO: absraction for LootTableIdGetter in modded
