...
/**
 * Precompiled multiloader-neoforge script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class MultiloaderNeoforgePlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_MultiloaderNeoforge").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("xyz.jpenilla.resource-factory-neoforge-convention");
            target.getPluginManager().apply("io.github.dexman545.outlet");
            target.getPluginManager().apply("com.modrinth.minotaur");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_MultiloaderNeoforge").asSubclass(BasicScript.class);
