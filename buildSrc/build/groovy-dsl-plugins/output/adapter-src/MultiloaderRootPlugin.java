...
/**
 * Precompiled multiloader-root script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class MultiloaderRootPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_MultiloaderRoot").asSubclass(BasicScript.class);
