...
/**
 * Precompiled multiloader-base script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class MultiloaderBasePlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_MultiloaderBase").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_MultiloaderBase").asSubclass(BasicScript.class);
