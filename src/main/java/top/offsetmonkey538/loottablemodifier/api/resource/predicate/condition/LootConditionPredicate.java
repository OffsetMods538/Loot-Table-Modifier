...
public record LootConditionPredicate(@NotNull RegexPattern functionPattern) {
    public static final Codec<LootConditionPredicate> CODEC = RegexPattern.CODEC.xmap(LootConditionPredicate::new, LootConditionPredicate::functionPattern);
