...
For making a drop only appear from a player kill, the [`condition_add`](/reference/actions#condition-add) action should be used to add the vanilla `killed_by_player` condition.
